...
index_names = dataset[dataset['Species'] == 'Iris-versicolor'].index
...
dataset_train_versicolor = dataset_versicolor.loc[dataset_versicolor.index < 2]
dataset_train_virginica = dataset_virginica.loc[dataset_virginica.index < 2]
